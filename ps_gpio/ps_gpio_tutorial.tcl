...
################################################################
# This is a generated script based on design: ps_gpio_tutorial
#
...
# source ps_gpio_tutorial_script.tcl
...
set design_name ps_gpio_tutorial
...
proc create_root_design { parentCell } {
  ...
  # Create instance: and_gate_4bit, and set properties
  set and_gate_4bit [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 and_gate_4bit ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {and} \
   CONFIG.C_SIZE {4} \
   CONFIG.LOGO_FILE {data/sym_andgate.png} \
  ...
  set or_gate [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 or_gate ]
  set_property -dict [ list \
  ...
  connect_bd_net -net and_gate_4bit_Res [get_bd_pins and_gate_4bit/Res] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net and_gate_Res [get_bd_pins and_gate/Res] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net not_gate_Res [get_bd_pins not_gate/Res] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net or_gate_Res [get_bd_pins or_gate/Res] [get_bd_pins xlconcat_0/In3]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins and_gate/Op1] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins and_gate/Op2] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins not_gate/Op1] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins or_gate/Op1] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins or_gate/Op2] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins xlslice_5/Dout] [get_bd_pins xor_gate/Op1]
  connect_bd_net -net xlslice_6_Dout [get_bd_pins xlslice_6/Dout] [get_bd_pins xor_gate/Op2]
  connect_bd_net -net xlslice_7_Dout [get_bd_pins and_gate_4bit/Op1] [get_bd_pins xlslice_7/Dout]
  connect_bd_net -net xlslice_8_Dout [get_bd_pins and_gate_4bit/Op2] [get_bd_pins xlslice_8/Dout]
  connect_bd_net -net xor_gate_Res [get_bd_pins xlconcat_0/In4] [get_bd_pins xor_gate/Res]
